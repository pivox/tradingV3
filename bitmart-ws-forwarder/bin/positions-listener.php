...
use App\{HttpClient, BitmartWsClient, PositionsWorker};
...
$endpoint = (string)$env('SYMFONY_POSITIONS_ENDPOINT', '/api/bitmart/positions');
...
$worker = new PositionsWorker($ws, $http, $endpoint, $reconnectBaseMs, $reconnectMaxMs);
$worker->run();
