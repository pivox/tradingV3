...
/**
 * Représente le signal REST envoyé à trading-app pour synchroniser le solde USDT.
 */
final class BalanceSignal
{
    ...
    private function __construct(private array $payload)
    {
        ...
        if ($missing !== []) {
            throw new \InvalidArgumentException(
                sprintf('BalanceSignal payload missing required fields: %s', implode(', ', $missing))
            );
        }
