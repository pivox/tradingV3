    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            if ($symbol) {
                ...
                $contracts = [$this->mainProvider->getContractProvider()->getContractDetails($symbol)];
            } else {
                $io->info('Récupération de tous les contrats disponibles...');
                $contracts = $this->mainProvider->getContractProvider()->getContracts();
            }
        ...
        foreach ($contracts as $contract) {
            ...
            if ($contract instanceof \App\Provider\Bitmart\Dto\ContractDto) {
                $rows[] = [
                    ...
                    'N/A', // min_size non disponible dans le DTO
                    'N/A', // max_size non disponible dans le DTO
                    'N/A', // tick_size non disponible dans le DTO
                    $contract->status ?? 'N/A'
                ];
            } else {
                // Tableau associatif
