...
final class MacdLineCrossDownWithHysteresisCondition extends AbstractCondition
{
    public const NAME = 'macd_line_cross_down_with_hysteresis';
    ...
    public function evaluate(array $context): ConditionResult
    {
        ...
        for ($off = 0; $off <= $maxOffset; $off++) {
            ...
            if ($condNow && (!$requirePrevAbove || $condPrev)) {
                $passed = true;
                $barsSince = $off;
                $triggerGap = $curr;
                $prevGap = $prev;
