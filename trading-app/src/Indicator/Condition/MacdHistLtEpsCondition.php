...
#[AsIndicatorCondition(timeframes: ['15m', '1h', '1m', '5m'], side: 'short', name: 'macd_hist_lt_eps')]
#[AutoconfigureTag('app.indicator.condition')]
#[AsTaggedItem(index: 'macd_hist_lt_eps')]
final class MacdHistLtEpsCondition extends AbstractCondition
{
    private const NAME = 'macd_hist_lt_eps';
