...
#[AsIndicatorCondition(timeframes: ['15m', '1h'], side: 'long', name: self::NAME)]
#[AutoconfigureTag('app.indicator.condition')]
#[AsTaggedItem(index: self::NAME)]
final class MacdHistSlopePosCondition extends AbstractCondition
{
    public const NAME = 'macd_hist_slope_pos';

    public function getName(): string { return self::NAME; }

    protected function getDefaultDescription(): string
    {
        return "Pente de l'histogramme MACD positive (MACD en amélioration).";
    }
