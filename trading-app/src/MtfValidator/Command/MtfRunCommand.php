...
class MtfRunCommand extends Command
{
                ...
                try {
                    ...
                    if (!empty($symbols)) {
                        ...
                        foreach ($allContracts as $contract) {
                            ...
                            $indexedContracts[strtoupper($contract->symbol)] = $contract;
                        }
    ...
    {
        $request = new \App\Contract\MtfValidator\Dto\MtfRunRequestDto(
            symbols: $symbols,
    ...
    /**
     * Convertit la réponse DTO en générateur compatible
     */
    private function convertResponseToGenerator(\App\Contract\MtfValidator\Dto\MtfRunResponseDto $response): \Generator
    {
        // Pour l'instant, on retourne un générateur vide
        // Cette méthode devra être implémentée selon les besoins
        yield [];
    }
}
