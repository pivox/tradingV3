...
use App\MtfValidator\ConditionLoader\Cards\Validation\Side;
use App\MtfValidator\ConditionLoader\Cards\Validation\TimeframeValidation;
...
class TimeframeEvaluator
{
    ...
    private function getTimeframeCard(string $tf): ?TimeframeValidation
    {
        ...
        if (!$validation) {
            // La validation doit être chargée depuis l'extérieur du module MtfValidator
