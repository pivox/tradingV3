...
namespace App\MtfRunner\Entity;

use App\MtfRunner\Repository\MtfRunRepository;
...
class MtfRun
{
    ...
    private ?string $listSymbolsToProcess = null;
    ...
    /**
     * @param bool $listSymbolsToProcess
     */
    public function setListSymbolsToProcess(string $listSymbolsToProcess): void
    {
        $this->listSymbolsToProcess = $listSymbolsToProcess;
    }

    /**
     * @return string|null
     */
    public function getListSymbolsToProcess(): ?string
    {
        return $this->listSymbolsToProcess;
    }
