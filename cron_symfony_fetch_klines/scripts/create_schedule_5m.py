...
WORKFLOW_TYPE = "CronSymfony5mWorkflow"            # doit matcher @workflow.defn(name=...)
WORKFLOW_ID   = "cron-symfony-5m-runner"

# L’endpoint Symfony appelé par le workflow (tu l’as déjà ajouté)
SYM_CRON_URL  = os.getenv("SYM_CRON_URL", "http://nginx/api/bitmart/cron/refresh-5m")

SCHEDULE_ID   = "cron-symfony-5m"
CRON_EXPR     = "*/5 * * * *"                      # toutes les 5 minutes
