...
SCHEDULES: Dict[str, Dict[str, Any]] = {
    "1m": {
        "schedule_id": "cron-symfony-ask-1m",
        "workflow_type": "CronSymfony1mWorkflow",
        "workflow_id": "cron-symfony-ask-1m-runner",
        "cron": "*/1 * * * *",
        "jobs": [
            EndpointJob(url="http://nginx/api/batch/ask-for-refresh/1m"),
            EndpointJob(url="http://nginx/api/refresh-opened-locked"),
        ],
    },
    "5m": {
        "schedule_id": "cron-symfony-ask-5m",
        "workflow_type": "CronSymfony5mWorkflow",
        "workflow_id": "cron-symfony-ask-5m-runner",
        "cron": "*/5 * * * *",
        "jobs": [
            EndpointJob(url="http://nginx/api/batch/ask-for-refresh/5m"),
        ],
    },
    "15m": {
        "schedule_id": "cron-symfony-ask-15m",
        "workflow_type": "CronSymfony15mWorkflow",
        "workflow_id": "cron-symfony-ask-15m-runner",
        "cron": "*/15 * * * *",
        "jobs": [
            EndpointJob(url="http://nginx/api/batch/ask-for-refresh/15m"),
        ],
    },
    "1h": {
        "schedule_id": "cron-symfony-ask-1h",
        "workflow_type": "CronSymfony1hWorkflow",
        "workflow_id": "cron-symfony-ask-1h-runner",
        "cron": "0 */1 * * *",
        "jobs": [
            EndpointJob(url="http://nginx/api/batch/ask-for-refresh/1h"),
        ],
    },
    "4h": {
        "schedule_id": "cron-symfony-ask-4h",
        "workflow_type": "CronSymfony4hWorkflow",
        "workflow_id": "cron-symfony-ask-4h-runner",
        "cron": "0 */4 * * *",
        "jobs": [
            EndpointJob(url="http://nginx/api/batch/ask-for-refresh/4h"),
        ],
    },
}
