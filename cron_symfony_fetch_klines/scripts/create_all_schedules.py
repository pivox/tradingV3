...
SCHEDULES: Dict[str, Dict[str, Any]] = {
    "1m": {
        ...
        "cron": "*/1 * * * *",
        "url": os.getenv("SYM_CRON_URL_1M", "http://nginx/api/bitmart/cron/refresh-1m"),
    },
    "5m": {
        ...
        "cron": "*/5 * * * *",
        "url": os.getenv("SYM_CRON_URL_5M", "http://nginx/api/bitmart/cron/refresh-5m"),
    },
    "15m": {
        ...
        "cron": "*/15 * * * *",
        "url": os.getenv("SYM_CRON_URL_15M", "http://nginx/api/bitmart/cron/refresh-15m"),
    },
    "1h": {
