...
SCHEDULE_ID = os.getenv("SCALPER_MICRO_SCHEDULE_ID", "cron-symfony-mtf-workers-scalper-micro-1m")
WORKFLOW_ID = os.getenv("SCALPER_MICRO_WORKFLOW_ID", "cron-symfony-mtf-workers-scalper-micro-runner")
WORKFLOW_TYPE = "CronSymfonyMtfWorkersWorkflow"
CRON_EXPRESSION = os.getenv("SCALPER_MICRO_CRON", "*/1 * * * *")
...
def make_job() -> Dict[str, Any]:
    return {
        ...
        "dry_run": False,
        "mtf_profile": "scalper_micro",  # Profile spécifique pour scalper_micro
    }
