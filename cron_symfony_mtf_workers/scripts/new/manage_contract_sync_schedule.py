...
SCHEDULE_ID = "cron-contract-sync-daily-9am"
WORKFLOW_ID = "contract-sync-runner"
...
DEFAULT_URL = "http://trading-app-nginx:80/api/mtf/sync-contracts"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Manage the Contract Sync schedule (daily at 09:00 UTC)")
