...
> **Superseded certification status (updated 2026-08-20).** This checked plan
> preserves Prompt 6's historical implementation record. The current plan is
> [`2026-08-20-issue-196-golden-20-fresh-stack.md`](2026-08-20-issue-196-golden-20-fresh-stack.md)
